...
import { t as mouseTracker, n as PerlinNoise, i as shaderChunks } from './Mouse.js';

const A = { default: PoissonDiskSampling };
const t = THREE.Raycaster;
const n = THREE.Vector2;
const r = THREE.ShaderMaterial;
const i = THREE.Vector3;
const a = THREE.RGBAFormat;
const o = THREE.Scene;
const s = THREE.NearestFilter;
const c = dat.GUI;
const l = THREE.PlaneGeometry;
const u = THREE.BufferGeometry;
const d = THREE.ColorManagement;
const f = THREE.DataTexture;
const p = THREE.MeshBasicMaterial;
const m = THREE.Mesh;
const h = shaderChunks;
const g = THREE.WebGLRenderTarget;
class EffectTimer {
  constructor() {
